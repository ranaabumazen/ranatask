...
free -m | awk 'NR==2 {print $4,$3}'  |awk '{totallm +=$2;countsm++ }END {print totallm/countsm}' >> /var/www/html/memavg
...
mpstat -P ALL | awk '{print (100.00-$13),$13}'|sed '1d;2d;3d' | awk '{totallc +=$2;countcs++ }END {print totallc/countcs}'>> /var/www/html/cpuavg
...
df | awk '{print $4}'|sed  '1d' |awk '{totall +=$1;counts++ }END {print totall/counts}' >> /var/www/html/diskavg
